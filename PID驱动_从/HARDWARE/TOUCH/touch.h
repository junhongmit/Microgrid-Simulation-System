...
//电阻屏芯片连接引脚	   
#define PEN  		PBin(1)  	//PB1 INT
#define DOUT 		PBin(2)   	//PB2  MISO
#define TDIN 		PFout(11)  	//PF11  MOSI
#define TCLK 		PBout(0)  	//PB0  SCLK
...
void TP_PreAdjust(void);
void TP_Adjust(void);							//触摸屏校准
void TP_Adj_Info_Show(u16 x0,u16 y0,u16 x1,u16 y1,u16 x2,u16 y2,u16 x3,u16 y3,u16 fac1,u16 fac2);//显示校准信息
//电阻屏/电容屏 共用函数
u8 TP_Scan(u8 tp);								//扫描
u8 TP_Init(void);								//初始化
