...
void LCD_Fill(u16 sx,u16 sy,u16 width,u16 height,u16 color);		   				//填充单色
void LCD_Color_Fill(u16 sx,u16 sy,u16 width,u16 height,const unsigned char *color);				//填充指定颜色
